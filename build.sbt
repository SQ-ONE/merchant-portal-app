...
lazy val `merchant-portal-app` = (project in file("."))
  .aggregate(`merchant-portal-app-api`, `merchant-portal-app-impl`)

lazy val `merchant-portal-app-api` = (project in file("merchant-portal-app-api"))
  .settings(
...
lazy val `merchant-portal-app-impl` = (project in file("merchant-portal-app-impl"))
  ...
  .dependsOn(`merchant-portal-app-api`)
